...
import { BarChart3, Users, BookOpen, FileQuestion, Settings, Shield, Activity, Database, MessageSquare, LogOut, KeyRound } from "lucide-react";
var navigation = [
...
export default function AdminSidebar() {
    ...
    return (<div className="flex flex-col w-64 bg-gray-900 dark:bg-gray-950">
        ...
        <ul className="space-y-2">
          {navigation.map(function (item) {
            ...
            return (<li key={item.name}>
                <Link href={item.href}>
                  <div className={cn("group flex items-center px-2 py-2 text-sm font-medium rounded-md transition-colors cursor-pointer", isActive
      ...
      <div className="px-4 pb-4 border-t border-gray-700">
        <div className="space-y-2 mt-4">
          ...
          <Button onClick={handleLogout} variant="ghost" className="w-full justify-start text-gray-300 hover:bg-gray-700 hover:text-white">
