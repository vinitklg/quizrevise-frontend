...
var DashboardLayout = function (_a) {
    ...
    return (<div className="flex h-screen overflow-hidden">
      ...
      {/* Mobile Sidebar */}
      {isSidebarOpen && (<div className="fixed inset-0 z-50 md:hidden">
          <div className="fixed inset-0 bg-black bg-opacity-50" onClick={function () { return setIsSidebarOpen(false); }}/>
      ...
      <div className="flex flex-col flex-1 overflow-hidden">
        ...
        <div className="md:hidden bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 px-4 py-3 flex items-center justify-between">
          <div className="flex items-center">
            <Button variant="ghost" size="sm" onClick={function () { return setIsSidebarOpen(true); }} className="mr-2">
