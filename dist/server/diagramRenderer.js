...
async function renderMathDiagram(instruction, questionId) {
...
async function renderPhysicsDiagram(instruction, questionId) {
...
async function renderChemistryDiagram(instruction, questionId) {
...
async function renderBiologyDiagram(instruction, questionId) {
...
async function renderEconomicsDiagram(instruction, questionId) {
...
async function renderBusinessDiagram(instruction, questionId) {
...
async function renderGeneralDiagram(instruction, questionId) {
...
function generateCyclicQuadrilateralSVG(instruction) {
    ...
    <svg width="450" height="350" xmlns="http://www.w3.org/2000/svg">
      ...
      <!-- Vertices -->
      ${Object.entries(vertices).map(([vertex, pos]) => `<circle cx="${pos.x}" cy="${pos.y}" r="4" class="point" />`).join('\n      ')}
      
      <!-- Vertex Labels -->
      ${Object.entries(vertices).map(([vertex, pos]) => `<text x="${pos.labelX}" y="${pos.labelY}" class="label">${vertex}</text>`).join('\n      ')}
...
function generateTriangleSVG(instruction) {
    return `
...
function generateCircleSVG(instruction) {
...
function generateRayDiagramSVG(instruction) {
    return `
...
function generateCircuitSVG(instruction) {
    return `
    <svg width="400" height="300" xmlns="http://www.w3.org/2000/svg">
      <defs>
        <style>
...
function generateApparatusSVG(instruction) {
    return `
...
function generateCellSVG(instruction) {
    return `
    <svg width="400" height="300" xmlns="http://www.w3.org/2000/svg">
      <defs>
        <style>
...
function generateSupplyDemandSVG(instruction) {
    return `
    <svg width="400" height="300" xmlns="http://www.w3.org/2000/svg">
      <defs>
        <style>
...
function generateFlowchartSVG(instruction) {
    return `
...
function generateCylinderSVG(instruction) {
...
function generateParallelogramSVG(instruction) {
    return `
    <svg width="400" height="300" xmlns="http://www.w3.org/2000/svg">
      <defs>
        <style>
...
function generateCongruentTrianglesSVG(instruction) {
    return `
    <svg width="500" height="300" xmlns="http://www.w3.org/2000/svg">
      <defs>
        <style>
...
function generateMidpointTheoremSVG(instruction) {
    return `
    <svg width="400" height="300" xmlns="http://www.w3.org/2000/svg">
      <defs>
        <style>
...
function generatePythagorasTheoremSVG(instruction) {
    return `
    <svg width="400" height="300" xmlns="http://www.w3.org/2000/svg">
      <defs>
        <style>
...
function generateChordPropertiesSVG(instruction) {
    return `
    <svg width="400" height="300" xmlns="http://www.w3.org/2000/svg">
      <defs>
        <style>
...
function generateQuadrilateralSVG(instruction) {
    return `
    <svg width="400" height="300" xmlns="http://www.w3.org/2000/svg">
      <defs>
        <style>
...
function generateCuboidSVG(instruction) {
    return `
    <svg width="400" height="300" xmlns="http://www.w3.org/2000/svg">
      <defs>
        <style>
...
function generateCoordinateGeometrySVG(instruction) {
    return `
    <svg width="400" height="300" xmlns="http://www.w3.org/2000/svg">
      <defs>
        <style>
...
function generateLinearEquationSVG(instruction) {
    return generateCoordinateGeometrySVG(instruction);
}
function generateNumberLineSVG(instruction) {
    return `
...
function generatePolynomialSVG(instruction) {
    return generateCoordinateGeometrySVG(instruction);
}
function generateBarGraphSVG(instruction) {
    return `
    <svg width="400" height="300" xmlns="http://www.w3.org/2000/svg">
      <defs>
        <style>
...
function generatePieChartSVG(instruction) {
    return `
    <svg width="400" height="300" xmlns="http://www.w3.org/2000/svg">
      <defs>
        <style>
...
function generateConstructionSVG(instruction) {
    return `
    <svg width="400" height="300" xmlns="http://www.w3.org/2000/svg">
      <defs>
        <style>
...
function generateHexagonSVG(instruction) {
    return `
    <svg width="400" height="300" xmlns="http://www.w3.org/2000/svg">
      <defs>
        <style>
...
function generateTrigonometrySVG(instruction) {
    return `
    <svg width="400" height="300" xmlns="http://www.w3.org/2000/svg">
      <defs>
        <style>
...
function generateRectangleSVG(instruction) {
    return generateGenericMathSVG(instruction);
}
function generateAngleSVG(instruction) {
    return generateGenericMathSVG(instruction);
}
function generateGenericMathSVG(instruction) {
    return `
    <svg width="400" height="300" xmlns="http://www.w3.org/2000/svg">
      <defs>
        <style>
...
function generateWaveSVG(instruction) {
    return generateGenericPhysicsSVG(instruction);
}
function generateForceDiagramSVG(instruction) {
    return generateGenericPhysicsSVG(instruction);
}
function generateGenericPhysicsSVG(instruction) {
    return `
    <svg width="400" height="300" xmlns="http://www.w3.org/2000/svg">
      <defs>
        <style>
...
function generateMolecularStructureSVG(instruction) {
    return generateGenericChemistrySVG(instruction);
}
function generateReactionSVG(instruction) {
    return generateGenericChemistrySVG(instruction);
}
function generateGenericChemistrySVG(instruction) {
    return `
    <svg width="400" height="300" xmlns="http://www.w3.org/2000/svg">
      <defs>
        <style>
...
function generateAnatomySVG(instruction) {
    return generateGenericBiologySVG(instruction);
}
function generateProcessSVG(instruction) {
    return generateGenericBiologySVG(instruction);
}
function generateGenericBiologySVG(instruction) {
    return `
    <svg width="400" height="300" xmlns="http://www.w3.org/2000/svg">
      <defs>
        <style>
...
function generateEconomicsGraphSVG(instruction) {
    return generateGenericEconomicsSVG(instruction);
}
function generateGenericEconomicsSVG(instruction) {
    return `
    <svg width="400" height="300" xmlns="http://www.w3.org/2000/svg">
      <defs>
        <style>
...
function generateOrgChartSVG(instruction) {
    return generateGenericBusinessSVG(instruction);
}
function generateGenericBusinessSVG(instruction) {
    return `
    <svg width="400" height="300" xmlns="http://www.w3.org/2000/svg">
      <defs>
        <style>
...
function generateGenericSVG(instruction) {
    return `
    <svg width="400" height="300" xmlns="http://www.w3.org/2000/svg">
      <defs>
        <style>
...
function generateEconomicsDiagramSVG(instruction) {
    const lower = instruction.toLowerCase();
    // Demand & Supply Curve
...
function generateDemandSupplyGraphSVG(instruction) {
    const lower = instruction.toLowerCase();
...
// Production Possibility Curve (PPC)
function generatePPCGraphSVG(instruction) {
    return `
    <svg width="500" height="400" viewBox="0 0 500 400" xmlns="http://www.w3.org/2000/svg">
      <defs>
        <style>
