...
export const standardizedSubjects = Object.entries(subjectData).flatMap(([board, grades]) => Object.entries(grades).flatMap(([grade, subjectList]) => subjectList.map((subject) => ({
    code: subject.code,
    name: subject.name,
    board,
