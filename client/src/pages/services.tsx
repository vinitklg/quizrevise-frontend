        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-12 grid grid-cols-2 gap-8 md:grid-cols-3 lg:grid-cols-4">
            {["Mathematics", "Physics", "Chemistry", "Biology", "English", "History", "Geography", "Computer Science", 
              "Social Studies", "Economics", "Business Studies", "Accountancy", "Political Science", "Hindi", "Sanskrit"].map((subject) => (
              <div key={subject} className="bg-gray-50 dark:bg-gray-800 rounded-lg p-6 text-center">
